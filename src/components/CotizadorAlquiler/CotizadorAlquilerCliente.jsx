...
const CotizadorAlquilerCliente = ({handleChange, handleSubmitThanks, rentUser, handleCancel}) => {
  return (
    ...
    <input name="phone" className="rent-user-input" value={rentUser.phone} type="number" onChange={handleChange} placeholder="Teléfono" required={true}/>
    <input name="cuit" className="rent-user-input" value={rentUser.cuit} type="number" onChange={handleChange} placeholder="CUIT" required={true}/>
