...
{/*       <a href='/carrousel'>
      ...
      <MobileView>
        <NosotrosMobile us={text.us} usRef={usRef} teamRef={teamRef} comRef={comRef} reinsurersRef={reinsurersRef} handleButtonClicked={handleButtonClicked} staff={text.staff} reisurance={text.reisurance} compromise={text.compromise}/>
      </MobileView>
    </div>
