...
const CotizadorForm = ({handleChange, handleSubmit, rentData}) => {
  return (
    ...
    <i className='i'>$</i>
        <input name="rent" className="light-input-rent" value={rentData.rent} type="number" onChange={handleChange} required={true} />
    <p className='rent-label'>Expensas</p>
    <i className='i'>$</i>
        <input name="expenses" value={rentData.expenses} id="prueba" className='light-input-rent' type="number" onChange={handleChange} required={true}  /> 
